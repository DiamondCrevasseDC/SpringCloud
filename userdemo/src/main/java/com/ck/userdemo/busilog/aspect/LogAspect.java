package com.ck.userdemo.busilog.aspect;
...
public class LogAspect {
    ...
    @AfterReturning(value = "@annotation(com.ck.userdemo.busilog.annotaion.LogConfig)", returning = "resultValue")
    public void afterReturning(JoinPoint jp, Object resultValue){
        log(jp, resultValue, null);
    }

    @AfterThrowing(value = "@annotation(com.ck.userdemo.busilog.annotaion.LogConfig)", throwing = "error")
